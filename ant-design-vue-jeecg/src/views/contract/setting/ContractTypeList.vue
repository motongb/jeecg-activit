<template>
  <a-card :bordered="false">
    ...
    <div class="table-operator">
      ...
      <a-button type="primary" icon="download" @click="handleExportXls('合同类型')">导出</a-button>
    ...
    <contractType-modal ref="modalForm" @ok="modalFormOk"></contractType-modal>
  </a-card>
</template>
...
<script>
  ...
  import ContractTypeModal from './modules/ContractTypeModal'
  ...
  export default {
    ...
    data () {
      return {
        ...
        url: {
          list: "/contract/contractType/rootList",
          childList: "/contract/contractType/childList",
          getChildListBatch: "/contract/contractType/getChildListBatch",
          delete: "/contract/contractType/delete",
          deleteBatch: "/contract/contractType/deleteBatch",
          exportXlsUrl: "/contract/contractType/exportXls",
          importExcelUrl: "contract/contractType/importExcel",
        },
        expandedRowKeys:[],
