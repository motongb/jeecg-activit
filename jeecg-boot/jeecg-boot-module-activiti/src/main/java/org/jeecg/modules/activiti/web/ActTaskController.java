...
public class ActTaskController {
    ...
    public Result<Object> pass(@RequestBody TaskPassVo taskPassVo) {

        String id = taskPassVo.getId();
        String procInstId = taskPassVo.getProcInstId();
        Integer priority = taskPassVo.getPriority();
        String comment = taskPassVo.getComment();
        Boolean sendMessage = taskPassVo.getSendMessage();
        Boolean sendSms = taskPassVo.getSendSms();
        Boolean sendEmail = taskPassVo.getSendEmail();
        ...
        List<Map<String, String>> assigneesList = taskPassVo.getAssignees();
        /*会签思路：
    ...
    private void cancelTask(String procInstId, Task task, ActBusiness actBusiness) {
