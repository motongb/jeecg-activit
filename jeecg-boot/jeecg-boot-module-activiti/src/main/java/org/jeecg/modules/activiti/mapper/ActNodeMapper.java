...
public interface ActNodeMapper extends BaseMapper<ActNode> {
    ...
    List<LoginUser> findUserByDepIds(@Param("departIds") List<String> departIds, @Param("username") String username);

    List<LoginUser> findUserByRoleId(@Param("id") String id);

    List<LoginUser> findUserByRoleIds(@Param("ids") List<String> roleIds);
