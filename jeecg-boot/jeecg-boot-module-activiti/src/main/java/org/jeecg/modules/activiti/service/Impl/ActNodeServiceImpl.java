...
public class ActNodeServiceImpl extends ServiceImpl<ActNodeMapper, ActNode> implements IActNodeService {
            ...
            for (PvmTransition tr : outTransitions) {
                ...
                if ("exclusiveGateway".equals(ac.getProperty("type"))) {
                    ...
                    if (outTransitionsTemp.size() == 1) {
                        ...
                        List<ActivityImpl> nextActivityImpl = getNextActivityImplByLineCondition(outTransitionsTemp, variables);
                        return nextTaskDefinition(CollectionUtils.isEmpty(nextActivityImpl) ? null : nextActivityImpl.get(0), activityId, variables, processInstanceId);
     ...
     * @return
     */
    public List<ActivityImpl> getNextActivityImplByLineCondition(List<PvmTransition> outTransitionsTemp,
        ...
        for (PvmTransition tr1 : outTransitionsTemp) {
            ...
            if (conStr != null) {// 有条件
                ...
                try {
                    ...
                    if (stringtoBoolean) {
                        activities.add((ActivityImpl) tr1.getDestination());
                    }
                } catch (ScriptException e) {
